...
# 2 — ⚠️⚠️ THE SEQUENCE — NINE SCREENS

⚠️⚠️ **RULED 16 AUGUST. THIS REPLACES EVERY EARLIER VERSION.**
...
4  ⚠️ THE KYC PROVIDER                 embedded, not a redirect — §2.2
        ↓
5  ⚠️⚠️ VERIFIED                       the photograph · we are generating your V.A.I.
        ↓                              ⚠️ REGISTER — name · email · phone
        ↓                              ⚠️ at least one contact required
6  ⚠️ OTP
        ↓
7  ⚠️ THE PLATFORM'S REQUIREMENTS      law enforcement declaration
        ↓                              + the signature agreement
8  ⚠️⚠️ SCAN YOUR FACE                 ⚠️ THE BASELINE IS SET HERE
        ↓
9  ⚠️ CONGRATULATIONS                  your V.A.I. · good for one year
                                       → go to the platform
```
...
| # | |
|---|---|
| 1 | ⚠️ **Name · email · phone.** ⚠️⚠️ **AT LEAST ONE CONTACT IS REQUIRED. NEITHER IS OPTIONAL ON ITS OWN.** |
...
# 13 — ⚠️ NOT YET WRITTEN DOWN

| # | |
|---|---|
| 1 | **Suspension, lockout, ban** |
| 2 | **Disclosure — the key coming back** |
| 3 | **Coupons** |
| 4 | **Origination and revenue share** |
| 5 | **V.A.I. Pro, in full** |
