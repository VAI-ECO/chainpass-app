...
DROP POLICY IF EXISTS "Allow authenticated read access" ON public.business_configurations;
...
DROP POLICY IF EXISTS "Allow public read for business list" ON public.business_configurations;
...
DROP POLICY IF EXISTS "Service role full access" ON public.business_configurations;
