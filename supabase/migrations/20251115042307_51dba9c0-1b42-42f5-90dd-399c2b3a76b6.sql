...
DROP POLICY IF EXISTS "Service role can insert webhook events" ON public.vairify_webhook_events;
...
DROP POLICY IF EXISTS "Service role can update webhook events" ON public.vairify_webhook_events;
...
DROP POLICY IF EXISTS "Service role can view webhook events" ON public.vairify_webhook_events;
...
DROP POLICY IF EXISTS "Service role can manage status updates" ON public.vai_status_updates;
