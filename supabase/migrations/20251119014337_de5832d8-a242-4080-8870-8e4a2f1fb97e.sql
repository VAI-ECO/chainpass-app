...
BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Public read access for verification photos" ON storage.objects;
...
ON storage.objects FOR SELECT
  ...
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Service role can upload verification photos" ON storage.objects;
