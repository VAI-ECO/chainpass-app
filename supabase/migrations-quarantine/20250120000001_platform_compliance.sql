...
DROP POLICY IF EXISTS "Service role can manage platform compliance" ON public.platform_compliance;
...
DROP POLICY IF EXISTS "Allow authenticated read access" ON public.platform_compliance;
...
DROP POLICY IF EXISTS "Service role can manage audit logs" ON public.compliance_check_audit;
