...
DROP POLICY IF EXISTS "Anyone can create verification records" ON public.verification_records;
CREATE POLICY "Anyone can create verification records"
ON public.verification_records FOR INSERT
WITH CHECK (true);

DROP POLICY IF EXISTS "Anyone can view their own verification records" ON public.verification_records;
CREATE POLICY "Anyone can view their own verification records"
ON public.verification_records FOR SELECT
USING (true);

DROP POLICY IF EXISTS "Anyone can update their own verification records" ON public.verification_records;
CREATE POLICY "Anyone can update their own verification records"
ON public.verification_records FOR UPDATE
USING (true);

DROP POLICY IF EXISTS "Anyone can create V.A.I. assignments" ON public.vai_assignments;
CREATE POLICY "Anyone can create V.A.I. assignments"
ON public.vai_assignments FOR INSERT
WITH CHECK (true);

DROP POLICY IF EXISTS "Anyone can view V.A.I. assignments" ON public.vai_assignments;
CREATE POLICY "Anyone can view V.A.I. assignments"
ON public.vai_assignments FOR SELECT
USING (true);

DROP POLICY IF EXISTS "Anyone can update V.A.I. assignments" ON public.vai_assignments;
...
DROP POLICY IF EXISTS "Anyone can create legal agreements" ON public.legal_agreements;
CREATE POLICY "Anyone can create legal agreements"
ON public.legal_agreements FOR INSERT
WITH CHECK (true);

DROP POLICY IF EXISTS "Anyone can view legal agreements" ON public.legal_agreements;
CREATE POLICY "Anyone can view legal agreements"
ON public.legal_agreements FOR SELECT
USING (true);

DROP POLICY IF EXISTS "Anyone can update legal agreements" ON public.legal_agreements;
