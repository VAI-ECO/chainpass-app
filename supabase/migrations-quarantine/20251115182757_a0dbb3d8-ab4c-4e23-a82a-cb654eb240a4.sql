...
DROP POLICY IF EXISTS "Anyone can insert business partner applications" ON public.business_partners;
...
DROP POLICY IF EXISTS "Admins can view all business partners" ON public.business_partners;
...
DROP POLICY IF EXISTS "Admins can update business partners" ON public.business_partners;
