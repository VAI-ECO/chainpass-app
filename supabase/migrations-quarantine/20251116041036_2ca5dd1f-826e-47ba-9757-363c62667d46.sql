...
DROP POLICY IF EXISTS "Admins can view all webhook deliveries" ON public.webhook_delivery_queue;
...
DROP POLICY IF EXISTS "Business partners can view their own webhook deliveries" ON public.webhook_delivery_queue;
