...
DROP POLICY IF EXISTS "Business partners can view their own test history" ON webhook_test_history;
...
DROP POLICY IF EXISTS "Service role can insert test history" ON webhook_test_history;
...
DROP POLICY IF EXISTS "Admins can view all test history" ON webhook_test_history;
